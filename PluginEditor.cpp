    ...
    : AudioProcessorEditor (&p), makoProcessor (p)
{
    ...
    butAmp4x.setButtonText("4x samp");
    ...
    labVersion.setText("v4.20s", juce::dontSendNotification);
...
void MakoDist01AudioProcessorEditor::Paint_Amp(juce::Graphics& g)
{
    ...
    g.drawText("Pre EQ", 325, 70, 50, 15, juce::Justification::centredLeft, 0);
...
void MakoDist01AudioProcessorEditor::resized()
{
    ...
    butAmp4x.setBounds(430, 70, 55, 15);     //R4.20 Added.
    butGetDefIR.setBounds(365, 70, 55, 15);
    ...
    cbAmpList.setBounds(40, 67, 280, 18); //R4.20 Moved and Reduced size.
...
{       
    ...
    if (butt == &butAmp4x)
    {
        labHelp.setText("4x SAMPLING: Reduce aliasing. Increases CPU usage.", juce::dontSendNotification);
...
{           
    ...
    if (FLAG_ClearHelp)
    {
        ...
        labHelp.setText("Mako Mini D - v4.20s", juce::sendNotification);
    }
